...
export function renderOrderSummary() {
  function updateCartQuantity() {
    ...
    document.querySelector('.js-cart-quantity-count').innerHTML = `${cartQuantity} items`;
  }
  let cartSummaryHTML = '';
  ...
  cart.cartItems.forEach((cartItem) => {
    document.querySelector(`.js-quantity-input-${cartItem.productId}`).addEventListener('keydown', (event) => {
      if (event.key === 'Enter') {
